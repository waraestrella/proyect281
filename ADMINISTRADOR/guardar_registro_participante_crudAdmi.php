...
$sql = "INSERT INTO usuario (nombre, apellido, telefono, email, contrasena, imagen,tipo_usuario,estado) VALUES ('$nombre', '$apellido', '$telefono', '$email', '$contrasena', '$imagen','participante','activo')";

if ($conn->query($sql) === TRUE) {
	echo "<script>alert('Registro guardado exitosamente.')</script>";
   header("Location: Admi_CrudParticipante.php"); // Redireccionar después de 3 segundos
} else {
