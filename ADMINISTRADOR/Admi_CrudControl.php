...
<div class="container-xl"><!--para el crud-->
	<div class="table-responsive">
          ...
          <a href="crearpdfControl.php" class="btn btn-primary"><i class="bi bi-printer"></i> Imprimir</a>
				</div>
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					<tr>
			            ...
			            $sql = "SELECT * FROM usuario where tipo_usuario = 'control'";
			            $result = $conn->query($sql);
  ...
  <div class="modal fade" id="addEmployeeModal" tabindex="-1" role="dialog" aria-labelledby="registroModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="registroForm" action="guardar_registro_control_crudAdmi.php" method="post" enctype="multipart/form-data">
        <div class="form-group">
          <label for="nombre">Nombre</label>
...
<div class="modal fade" id="eliminarUsuarioModal" tabindex="-1" role="dialog" aria-labelledby="eliminarUsuarioModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form action="eliminarUsuario_control.php" method="post">
