      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <h1 class="m-0" style="text-align: center;">Bienvenido Usuario Control</h1>
          </div><!-- /.col -->
	...
	<div class="table-responsive">
  		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2><b>Usuarios Expositores</b></h2>
					</div>
					<div class="col-sm-6">
          ...
          <a href="crearpdfExpositor.php" class="btn btn-primary"><i class="bi bi-printer"></i> Imprimir</a>
				</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="editar_usuario_expositor.php" method="POST">
  ...
  <div class="modal fade" id="addEmployeeModal" tabindex="-1" role="dialog" aria-labelledby="registroModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="registroForm" action="guardar_registro_expositor_crudAdmi.php" method="post" enctype="multipart/form-data">
        <div class="form-group">
          <label for="nombre">Nombre</label>
...
<div class="modal fade" id="eliminarUsuarioModal" tabindex="-1" role="dialog" aria-labelledby="eliminarUsuarioModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form action="eliminarUsuario_expositor.php" method="post">
