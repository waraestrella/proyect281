...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $sql = "UPDATE usuario SET nombre = '$nombre', apellido = '$apellido', telefono = '$telefono', email = '$email', tipo_usuario = '$tipo_usuario', estado = '$estado' WHERE id = $id";
  if (mysqli_query($conn, $sql)) {
    // Si la actualización fue exitosa, redirigir a la página de usuarios
    header("Location: Admi_CrudParticipante.php");
    exit();
  } else {
