...
$sql = "INSERT INTO usuario (nombre, apellido, telefono, email, contrasena, imagen,tipo_usuario,estado) VALUES ('$nombre', '$apellido', '$telefono', '$email', '$contrasena', '$imagen','administrador','activo')";
