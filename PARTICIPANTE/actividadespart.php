...
<title>PAGINA PARTICIOANTE</title>
...
.card {
  ...
  perspective: 1000px; /* Perspectiva para el efecto de volteo */
...
.flip-card-front {
  /* Estilos para el frente de la card */
}

.flip-card-back {
  transform: rotateY(180deg);
  /* Estilos para la parte trasera de la card */
}
  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <h1 class="m-0" style="text-align: center;">Bienvenido Partcicipante</h1>
          </div><!-- /.col -->
    ...
    <section class="content">
      <div>
         ...
         <a href="listado_de_eventos.php" class="btn btn-success"><i class="bi bi-arrow-left"></i> Volver al evento</a>
...
<?php
    ...
    if ($result !== false && $result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<div class='card flip-card'>";
            echo "<div class='flip-card-inner'>";
            echo "<div class='flip-card-front'>";
            echo "<img src='../imgactividad/" . $row['imagen'] . "' class='card-img-top' alt='Imagen de la actividad'>";
            echo "<div class='card-body'>";
            echo "<h5 class='card-title'>" . $row['nombre'] . "</h5>";
            echo "<p class='card-text'>" . $row['descripcion'] . "</p>";
            echo "</div>";
           
            echo "</div>"; // flip-card-front
            echo "<div class='flip-card-back'>";
            echo "<ul class='list-group list-group-flush'>";
            
            echo "<li class='list-group-item'><strong>Tipo:</strong> " . $row['tipo'] . "</li>";
            echo "<li class='list-group-item'><strong>Duración:</strong> " . $row['duracion'] . "</li>";
            echo "<li class='list-group-item'><strong>Fecha:</strong> " . $row['fecha'] . "</li>";
            echo "<li class='list-group-item'><strong>Hora:</strong> " . $row['hora'] . "</li>";
            echo "<li class='list-group-item'><strong>Expositor:</strong> " . $row['nomExpo'] . "</li>";
            echo "<li class='list-group-item'><strong>Ambiente:</strong> " . $row['nomAmbiente'] . "</li>";
            echo "</ul>";
            echo "</div>"; // flip-card-back
            echo "</div>"; // flip-card-inner
            echo "</div>"; // flip-card
        }
    } else {
