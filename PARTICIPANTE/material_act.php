...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        <?php
// Obtener el ID de la actividad desde el parámetro de la URL
$actividadId = $_GET['actividadId'];

// Consulta SQL para obtener los materiales de la actividad
$sql = "SELECT * FROM material WHERE actividad_id = $actividadId";
...
<div class="container">
        <h1>Materiales de la Actividad</h1>
            ...
            <tbody>
                <?php foreach ($results as $row) : ?>
                    <tr>
                        ...
                        <td><a href="../carpeta_material/<?php echo $row['nombre_archivo']; ?>" class="btn btn-primary">Descargar</a></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
