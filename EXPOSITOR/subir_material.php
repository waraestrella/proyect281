...
<head>
  ...
  <title>PAGINA EXPOSITOR</title>
    <!-- Agregar enlaces a los estilos de Bootstrap subir material-->
        ...
        if (isset($_GET['actividad_id'])) {
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                if (isset($_FILES['archivo']) && $_FILES['archivo']['error'] === UPLOAD_ERR_OK) {
                    ...
                    $carpetaDestino = '../carpeta_material/'; // Actualiza esta ruta con la carpeta donde deseas guardar los archivos
                    ...
                    if (move_uploaded_file($rutaTemporal, $rutaDestino)) {
                        ...
                        $sql = "INSERT INTO material (nombre_archivo, tipo_archivo, actividad_id) VALUES ('$nombreArchivo', '$tipoArchivo', $actividadId)";
                        if ($conn->query($sql) === true) {
                            echo '<div class="alert alert-success">El material se ha subido correctamente.</div>';
                        } else {
                            echo '<div class="alert alert-danger">Error al subir el material: ' . $conn->error . '</div>';
                        }
            ...
            echo '<div class="alert alert-danger">Error: No se ha proporcionado el ID de la actividad.</div>';
        }
        ?>

        <!-- Formulario de subida de material -->
